...
const colorConfig = {
  blue: {
    ...
    accentLine: "from-indigo-400 via-blue-500 to-indigo-600",
  },
  green: {
  ...
  purple: {
    ...
    accentLine: "from-purple-400 via-violet-500 to-purple-600",
  },
  cyan: {
    ...
    >
      <motion.div
        animate={{
          y: isHovered ? -4 : 0,
          boxShadow: isHovered
            ? `0 20px 40px -15px rgba(0, 0, 0, 0.15), 0 10px 20px -10px ${config.glow}`
